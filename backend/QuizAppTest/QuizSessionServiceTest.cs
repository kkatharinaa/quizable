...
namespace QuizApp
{
    ...
    public class QuizSessionServiceTest
    {
        ...
        public void Assert_Update_Quiz_Session_User_Add()
        {
            ...
            Assert.That(_quizSessionService.GetQuizSessionUserStats(quizUser.Id)?.User, Is.Not.Null.And.EqualTo(quizUser));
        }
        ...
        public void Assert_Update_Quiz_Session_User_Score()
        {
            ...
            // Assert
            Assert.That(_quizSessionService.GetQuizSessionUserStats(quizUser.Id), Is.Not.Null);
            Assert.That(_quizSessionService.GetQuizSessionUserStats(quizUser.Id)?.Score, Is.Not.Null.And.EqualTo(newScore));
        }
