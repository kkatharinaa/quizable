...
5. **Configure Firebase for web**:
   ...
   ![alt text](img/doc/firebase1.png)
...
9. **Set up Firestore Database**:
   ...
   ![alt text](img/doc/firebase2.png)
...
14. **Turn On Authentication**:
   ...
   ![alt text](img/doc/firebase3.png)
...
EMAIL_PORT="587"
EMAIL_ADDRESS="quizable.medialab@gmail.com"
EMAIL_PASSWORD="hhdy syva llnr amgx"
```
